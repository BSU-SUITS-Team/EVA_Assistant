...
This EVA assitant uses the Mistral 7B model, as well as an embedding model mxbai-embed-large. We will download these from the console using the ollama command.
